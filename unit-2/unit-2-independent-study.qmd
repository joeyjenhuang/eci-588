...
1.  **Identity a data source.** I've included the `ccss-tweets.csv` and `ccss-tweets.csv`data files from our case study in a data folder located the Unit 2 Analysis project in our [Posit Cloud ECI 588 Workspace](https://posit.cloud/spaces/738839/join?access_code=7T6vEWWqCSB_pGA_kMXmPT-aflK0xWRkUyw-C2v4). You are also welcome to identify your own text-based data source related to an area of personal or professional interest. However, if you choose to use an alternative data source, you will need to specify the context in which it was collected and the audience for whom your analysis intended.
...
If you have any questions about the assignment or run into any technical issues, don't hesitate to email me at joeyhuang\@ncsu.edu or set up a Zoom meeting at <https://calendar.app.google/8SctiFTFFtttvUm86>.
