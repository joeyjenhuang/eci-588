...
5.  Berkowitz, R. (2017). [Introduction to sentiment analysis](https://www.youtube.com/watch?v=65RP29Jll80). Retrieved from [https://youtu.be/65RP29Jll80](https://www.youtube.com/watch?v=65RP29Jll80)
...
The first article is co-authored by [Tiffany Barnes](https://www.csc.ncsu.edu/people/tmbarnes), professor of Computer Science at NCSU, and provides a nice bridge to our articles on LIWC. The second by faculty at Michigan State University demonstrates the use of sentiment analysis to explore tweets from two education conferences and provides an excellent discussion of some general applications for SA in education. The third article is by [Josh Rosenberg](https://joshuamrosenberg.com), and ties in with our Unit 2 Case Study. The last three articles show how SA has been applied to teacher evaluation surveys, student writing, and online course discussions respectively.
...
4.  Rajput, Q., Haider, S., & Ghani, S. (2016). [Lexicon-based sentiment analysis of teachers’ evaluation](http://doi.org/10.1155/2016/2385429). *Applied Computational Intelligence and Soft Computing*, 2016(3), 1–12. http://doi.org/10.1155/2016/2385429

5.  Sigman, B. P., Garr, W., Pongsajapan, R., Selvanadin, M., McWilliams, M., & Bolling, K. (2016). [Visualization of Twitter Data in the Classroom](https://onlinelibrary.wiley.com/doi/abs/10.1111/dsji.12108). *Decision Sciences Journal of Innovative Education*, *14*(4), 362-381. https://onlinelibrary.wiley.com/doi/abs/10.1111/dsji.12108
...
1.  Petrilli, M. (2015).[ What twitter says about the education policy debate](https://www.educationnext.org/twitter-says-education-policy-debate/). *Education Next*. [http://educationnext.org/files/ednext_XV_4_what_next.pdf](https://www.educationnext.org/twitter-says-education-policy-debate/)

2.  Varner, L. K., Roscoe, R. D., & McNamara, D. S. (2013). [Evaluative misalignment of 10th-grade student and teacher criteria for essay quality: An automated textual analysis](https://www.jowr.org/index.php/jowr/article/view/697). *Journal of Writing Research, 5(1), 35–59.* http://doi.org/10.17239/jowr-2013.05.01.2

3.  Robinson, R. L., Navea, R., & Ickes, W. (2013).[ Predicting final course performance from students' written self-introductions: A LIWC analysis](https://journals.sagepub.com/doi/10.1177/0261927X13476869). *Journal of Language and Social Psychology*. http://doi.org/10.1177/0261927X13476869
...
In lieu of the peer interaction and discussion that would normally take place in class, you will engage with other members of our learning community through the course discussion forum this week. To help guide our conversations, we will collectively respond to a set of guiding questions provided in each forum. You are also welcome to introduce your own topics or questions for the class to explore.

With the exception of the self-selected resource, you are **not** expected to post in every thread or respond to every question listed below, especially if others have already addressed a topic thoroughly. The primary goal of these discussions is to collectively deepen our understanding of this week’s topics through back-and-forth dialogue and to avoid a “collective monologue” with multiple variations of the same response.
...
3.  What new terms, concepts, or ideas did you encounter this week, or which familiar terms do you now understand more clearly?
...
1.  What types of dictionaries or lexicons were described in the readings, and how are they created?
2.  How can lexicons be used to classify, quantify, and/or measure a collection of documents? 
3.  Under what conditions or contexts are lexicons and associated measures more or less trustworthy?
4.  What type of lexicon might be useful to create in your own professional context?
...
3.  What are the key issues, challenges, or limitations of dictionary-based methods?
...
3.  What educational data sources might be particularly well suited for dictionary-based analysis?
4.  What data sources are you interested in exploring for an independent analysis or final course project?
