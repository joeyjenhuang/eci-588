...
![](images/Screenshot 2026-01-09 at 8.16.55 PM.png){fig-align="center" width="381"}

Next you'll be prompted to "Start with the course that Joey Huang has assigned to you" or "Go to the Dashboard -\>" instead. You're welcome to get started immediately on the **Introduction to R** course, but I recommend taking a quick visit to the group dashboard first. ![](images/Screenshot 2026-01-09 at 8.16.40 PM.png)
