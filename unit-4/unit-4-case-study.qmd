...
unit.A.point = set.ena$points$ENA_UNIT$`FirstGame.steven z`
```
...
ena.plot(set.ena, title = "Individual network: `FirstGame`.steven z") |> 
          ena.plot.network(network = as.vector(colMeans(unit.A.line.weights)), colors = c("red")) |>
...
unit.B.point = set.ena$points$ENA_UNIT$`SecondGame.samuel o`
```
...
ena.plot(set.ena, title = "Subtracted network: `FirstGame`.steven z (red) - `SecondGame`.samuel o (blue)")  |>
          ena.plot.network(network = (as.vector(colMeans(unit.A.line.weights)) - as.vector(colMeans(unit.B.line.weights))) * 5,
          colors = c("red", "blue")) |>
          ena.plot.points(points = unit.A.point, colors = c("red")) |> 
